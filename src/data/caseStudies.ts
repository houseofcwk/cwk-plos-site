...
export const CASE_STUDIES: CaseStudy[] = [
...

  {
    ...
    cardAccent: '#00E5FF',
    cardImage: '/images/work/stephy-lee.webp',
    cardImageAlt: 'Stephy Lee, music artist',
    ...
    body: [
      ...
      yt('https://www.youtube.com/embed/S581bcAIc7M?rel=0', 'Stephy Lee | First media after the accident'),
      ...
      p('Our strategy was simple and disciplined: document with intention and speed. Media production during this period included a documentary chronicling the accident and recovery, a series of music videos, and structured narrative assets that allowed people to understand the depth of what had happened without exploiting it.'),
      p('Through this work, $30,000 was raised: meaningful support, even if it barely dented the medical costs involved.'),
      p('The objective was never virality. It was continuity.'),
      yt('https://www.youtube.com/embed/6jwohv2JHRk?rel=0', 'Stephy Lee | Recovery documentation'),

      h2('Re-Entering the World, Deliberately'),
      p('Her first post-accident live performance happened 18 months later. She could barely walk, needing a cane for assistance. Her second album had just launched.'),
      ...
      p('The plan was simple: host an intimate 45-minute concert at the biggest non-profit in Austin supporting BIPOC creatives. Invite the founder. He runs a full SXSW showcase. If he liked what he saw, maybe she would get offered a slot.'),
      ...
      yt('https://www.youtube.com/embed/NGSAOOCiykI?rel=0', 'Stephy Lee | First music video after the accident'),
    ],
  },

  {
    ...
    cardAccent: '#00E5FF',
    cardImage: '/images/work/spraycation.webp',
    cardImageAlt: 'SPRAYCATION experiential mural tour',
    ...
    result: '6 cities',
    resultLabel: 'Tour executed',
    stats: [
      { value: '6 cities', label: 'Tour' },
      { value: '11 months', label: 'Live build' },
      { value: '2026', label: 'Scale ready' },
    ],
    body: [
      h2('SPRAYCATION'),
